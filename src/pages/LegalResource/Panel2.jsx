...
const FeedCard = () => {
	...
	const tags = ["Legal Aid", "Child Rights","Women Rights"];
	return (
		<> 
		<div style={proposal}>
			<Row className="g-0 justify-content-between">
				<Col className="mb-2">
					{/* Title */}
					<h5 className="mb-1">Legal Aid Society</h5>
					{/* Posted Time */}
					...
					<small className="text-gray-light ms-3">
						...
						<span className="ms-1">Karachi,  Pakistan </span>
					</small>
				</Col>
				<Col xs="auto">
			...
			<p className="my-3">Legal Aid Society is an NGO that provides free legal advice
			 in Karachi to those who cannot afford it. It also has a free online legal
			 advice helpline in Pakistan. It has offices in Karachi and Islamabad</p>
			{/* Tags */}
			<ChipGroup itemList={tags} color="primary" size="small" />
			{/* Proposals submitted */}
			<div className="my-2">
			<a href="https://las.org.pk/" target="_blank" rel="noreferrer">Click here To Visit</a>
			</div>
	...
	return (
		<>
			...
			{/* <Sticky top="#topNav" innerActiveClass="sticky-active" enabled={true} innerZ={1200} bottomBoundary="#main-content">
				<Card> 
					<Card.Body style={lable} className="p-0">
						<Tabs value={value} onChange={tabChange} indicatorColor="primary" textColor="primary" aria-label="Feed Tabs">
							<Tab  style={Navigate}  label="My Feed" />
							<Tab  style={Navigate} label="Best Matches" />
							<Tab  style={Navigate} label="Recommended" />
						</Tabs>
					</Card.Body>
				</Card>
			</Sticky> */}
